...
CFGBASE='-6relayd -kmod-wpad -odhcp6c -odhcpd -wpad-mini fastd kmod-batman-adv ip curl ecdsautils ppp-mod-pppoe haveged socat nano kmod-ath tc kmod-sched-core kmod-sched'
CFGHOTSPOT='hostapd'
