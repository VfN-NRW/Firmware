...
CFGBASE='-6relayd -kmod-wpad -odhcp6c -odhcpd -wpad-mini kmod-batman-adv batctl ebtables ip curl ecdsautils ppp-mod-pppoe haveged socat tc kmod-sched-core kmod-sched'
